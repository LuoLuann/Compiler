    ...
    class Parser {
        ...
        functionDeclaration() {
            ...
            // if (returnType !== null) {
            //     // Verifique se a função contém um retorno e se o tipo de retorno é válido
            //     const returnStatement = body.commands.find(command => command.type === "ReturnStatement");
        
            //     if (returnStatement) {
            //         console.log("returnStatement: ", returnStatement)
            //         console.log("returnType: ", returnType)
                    
            //         if (returnStatement.expression && returnStatement.expression.type !== returnType) {
            //             this.logError(
            //                 `O tipo de retorno da função "${id}" não é compatível com o tipo especificado "${returnType}".`,
            //                 this.currentToken()
            //             );
            //             throw new Error(`Erro Semântico: Tipo de retorno incompatível para a função "${id}".`);
            //         }
            //     } else {
            //         this.logWarning(
            //             `Função "${id}" especifica um tipo de retorno, mas não contém uma instrução de retorno.`,
            //             this.currentToken()
            //         );
            //     }
            // }
